...
public class ClsMesasEComandas
{
    ...
    [JsonPropertyName("CodigoExterno")] public int CodigoExterno { get; set; } = 1;
    [JsonPropertyName("Bloqueado")] public bool Bloqueado { get; set; }
    [JsonPropertyName("Ocupada")] public bool Ocupada { get; set; }
    ...
    [JsonPropertyName("apelido")] public string? apelido { get; set; }
    [JsonPropertyName("AguardandoPagamento")] public bool AguardandoPagamento { get; set; }
