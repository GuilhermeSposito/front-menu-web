...
// This file is used in production. Blazor WASM automatically populates the offline-assets.json with the project files.
...
async function onFetch(event) {
    ...
    if (event.request.method === 'GET') {
        ...
        // If you need handle special Cases, add them here.
